# genpark-multi-brand-cloud-kitchen-operating-system-pos-skill
...
> **GenPark AI Agent Skill** -- Multi-brand cloud kitchen OS and unified KDS dispatch system (Rebel Foods style)
